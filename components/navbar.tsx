...
const NavBar = () => {
    return (
        <header className='md:sticky h-24 px-10 md:px-20 flex flex-row items-center justify-between top-0 z-50 w-full border-b bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60'>
